...
2. Rate each product on multiple dimensions (0-10 scale)
3. Calculate an overall match score (0-100%) based on how well it meets user needs
4. Identify "unknown unknowns" - important factors the user should consider but didn't mention
5. Provide a clear final recommendation with reasoning
