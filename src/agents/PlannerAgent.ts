...
export class PlannerAgent {
  ...
  private createSystemPrompt(): string {
    return `You're a chill electronics shopping assistant. Keep it SHORT and casual.
...
- Use casual GenZ/Millennial language (not cringe tho)
...
- Say something like: "I think I have enough information to start the search. Are there any other preferences or considerations that I should know about OR should I go ahead and find you the best product right away?"
...
- "Got it" instead of "I understand that you're looking for..."
- "What's your budget?" instead of "Could you please share your budget range?"
